  ...
  <form method="post">
      ...
      <div class="card">
        ...
        <div class="grid cols-3">
          ...
          <div class="form-row"><label>Fecha nacimiento</label><input class="input" type="date" name="victima_fecha_nacimiento" value="<?php echo h($old['victima_fecha_nacimiento'] ?? ''); ?>" /></div>

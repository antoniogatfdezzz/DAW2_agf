...
// Recuperar datos de víctima del POST anterior
// Recuperar datos de víctima del POST anterior o desde sesión
// Recuperar datos de víctima del POST anterior o desde sesión
$datosVictima = [];
...
// Valores previos para repoblar inputs (aceptamos POST o GET)
$old = array_merge($_POST, $_GET);

// Sin sesiones: no procesamos aquí; el botón de continuar enviará POST a form-agresor.php con los hidden de víctima + los campos del hecho
?>
<!doctype html>
<html lang="es">
<head>
